        ...
        if (str === 'ru') {
            this.props.updateIntl({
                ...
                messages: Object.assign({
                    ...
                    'cabinet.thanks': 'Благодарность',
                    'cabinet.thanks_description': 'Пожалуйста, сделайте денежный перевод нашей команде, если вам понравился наш сервис. Мы будем очень благодарны.',
                    'cabinet.modal_decline': 'Не заслужили',
                    'cabinet.modal_confirm': 'Хорошо',
                    'footer.msg': 'Запилили: ',
